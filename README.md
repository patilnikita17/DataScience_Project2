...
This project focuses on building a Sales Data Dashboard to help decision-makers quickly understand business performance using data visualization.
...
Type: Retail transactional sales data
...
📸 Screenshot: images/region_sales.png
...
📸 Screenshot: images/category_sales.png

4️⃣ Top 5 States by Sales

Horizontal bar chart ranking the top 5 revenue-generating states

Useful for regional focus and expansion decisions

📸 Screenshot: images/top_states_sales.png
